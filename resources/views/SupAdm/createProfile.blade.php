                        ...
                        <div class="col-lg-4">
                            <div class="card mb-4">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted mb-4">Any Updates to your Profile? <br> Edit Profile with the most
                                        current State To Keep it Up To Date.</p>
                                    <hr>
                                    <div class="form-check mb-3">
                                        <label id="bio_label" for="bio" class="required text-warning">A Short Bio About
                                            Yourself</label>
                                        <textarea id="bio" name="bio" rows="5" class="form-control text-body" >{{ old('bio') }}</textarea>
                                        @error('bio')
                                    ...
                                    <div class="file-upload">
                                        <label class="text-info" for="profile">Profile Image <small class="text-danger text-small">100x100 px</small></label>
                                        <div class="custom-file">
                                            <div class="input-group mb-3">
                                                <input id="profile" name="profile" type="file"
                                                    ...
                                                    autofocus />
                                                @isset($user->Profile->profile)
                                                    <img src="{{ asset('images/profile/' . $user->Profile->profile) }}"
                                    ...
                                    <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <button type="submit" class="btn btn-outline-primary ms-1">Create BIO
                                            Profile</button>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input id="name" name="address" type="text" class="form-control"
                                                value="{{ old('address') }}" placeholder="Your Address" autofocus
                                                required />
